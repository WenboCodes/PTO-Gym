...
| `M<L>` | `!pto.vmi.mask<L>` 虚拟谓词，族 `G ∈ {b8,b16,b32}` 由所修饰数据类型推导（见 §0.3-1） |
...
> 还原连续态: `MRG4CHN_B32(P0, P1, P2, P3) → [x0 x1 x2 x3 x4 x5 ... x255]`（4 通道合并，按 P0/P1/P2/P3 轮换交织回 stride-1）。
...
pto.vmi.vstore %lo, %hi, %ub_out[%offset], %mask {dist-mode = "dintlv"}
    : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64>
